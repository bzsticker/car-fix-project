  ...
  if (error || !customer) {
    return (
      <div className="space-y-4">
        <Link href="/owner/customers" className="text-sm text-muted hover:text-white">
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-[0.28em] text-brand-red">Customer Profile (HQ)</p>
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link
            href={`/owner/jobs?customer_id=${customer.id}&open_create=1`}
              ...
              vehicles.map((vehicle) => (
                <div key={vehicle.id} className="rounded-lg border border-border bg-background/60 p-4">
                  ...
                  <div className="mt-3 flex flex-wrap gap-3 text-xs">
                    ...
                    <Link
                      href={`/owner/jobs?customer_id=${customer.id}&car_id=${vehicle.id}&open_create=1`}
                      className="text-muted hover:text-white"
                    >
                      Create Job Ticket
                    </Link>
